    ...
    <footer className="bg-gray-900 text-gray-100 px-6 py-12">
      ...
      <div className="max-w-6xl mx-auto mb-10 flex flex-col items-center">
        ...
        <div className="flex flex-wrap gap-6 justify-center items-center w-full">
          ...
          <div className="h-12 w-32 bg-gray-700 rounded flex items-center justify-center text-gray-300 text-xs">Sponsor 1</div>
          <div className="h-12 w-32 bg-gray-700 rounded flex items-center justify-center text-gray-300 text-xs">Sponsor 2</div>
          <div className="h-12 w-32 bg-gray-700 rounded flex items-center justify-center text-gray-300 text-xs">Sponsor 3</div>
          <div className="h-12 w-32 bg-gray-700 rounded flex items-center justify-center text-gray-300 text-xs">Sponsor 4</div>
        </div>
      </div>

      {/* Main Footer Content */}
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8 border-t border-gray-800 pt-10">
        {/* Services */}
        ...
        {/* Partners */}
        <nav className="flex flex-col gap-2">
          <h6 className="footer-title text-lg font-semibold mb-2">Onze partners</h6>
        ...
        {/* Social Media */}
        <div>
          <h6 className="footer-title text-lg font-semibold mb-2">Social media</h6>
          <div className="flex gap-4 mb-4">
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" className="fill-current hover:text-blue-400 transition-colors">
                <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"></path>
              </svg>
            </a>
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" className="fill-current hover:text-red-500 transition-colors">
                <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"></path>
              </svg>
            </a>
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" className="fill-current hover:text-blue-600 transition-colors">
        ...
        {/* Newsletter */}
        <div>
          <h6 className="footer-title text-lg font-semibold mb-2">Nieuwsbrief</h6>
