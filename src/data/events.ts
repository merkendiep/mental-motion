...
export const staticEvents: Event[] = [
  ...
  },
  {
    ...
    <p>
      ...
      Wil je praten met mensen die écht snappen hoe dat is?
    </p>
    <p>
      In de <strong>peer-groep</strong> gaan wij met een kleine groep leeftijdsgenoten aan de slag met wat ons bezighoudt. 
      Er is ruimte voor grote en kleine thema’s, voor herkenning en uitwisseling — zonder oordeel en zonder moeten. 
  ...
  },
  {
    ...
    <p>
      We’re excited to invite you to a collaborative session with <strong>In Touch Amsterdam</strong> 
      where we explore <em>voice, movement & self-expression</em> in a safe and creative space.
    </p>
    <p>
      No experience is needed – just bring yourself, curiosity, and an open mind. 
