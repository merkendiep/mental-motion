        ...
        <div className="flex flex-col bg-white pt-32">
            <div className={'px-4 mg:px-0'}>
                ...
                <div className="card mt-8 lg:mx-6 lg:w-1/2">
                    <div
                        className="card-body mx-auto w-full overflow-hidden rounded-lg px-8 py-10 shadow-xl outline outline-base-content/5 lg:max-w-xl">
                        ...
                        <form className="mt-6">
                            ...
                            <fieldset
                                className="fieldset w-full p-4 mt-4 bg-base-100 border border-base-300 rounded-box w-64">
