            ...
            <div className="flex flex-col items-center px-4">
                <div className="flex flex-col items-center gap-2">
                    ...
                    <p className="mt-2 text-center text-lg text-base-content max-w-xl">
                        Blijf op de hoogte van het laatste nieuws, tips en exclusieve acties.<br />
                ...
                <div className="card w-full max-w-xl shadow-2xl bg-base-100 border border-base-300/70">
                    <div className="card-body px-8 py-10">
                        <form className="space-y-8">
                            <div>
                                <label htmlFor="email" className="block text-base font-semibold text-primary mb-1">
                                    E-mailadres
                                </label>
                                <input
                                    id="email"
                            ...
                            <fieldset className="bg-base-200 border border-primary rounded-xl p-4">
                                <legend className="text-primary font-semibold px-2">Kies nieuwsbrief(s)</legend>
