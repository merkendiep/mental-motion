            ...
            <table className="table w-full text-xs sm:text-sm lg:text-base">
              <thead>
                <tr className="border-b border-base-300">
                  ...
                  <th className="bg-base-100 hidden md:table-cell p-2 sm:p-3 lg:p-4">Organization</th>
                  <th className="bg-base-100 p-2 sm:p-3 lg:p-4">Newsletters</th>
                  <th className="bg-base-100 hidden lg:table-cell p-2 sm:p-3 lg:p-4">Subscribed On</th>
                </tr>
              </thead>
              <tbody>
                {subscriptions.length > 0 ? (
                  subscriptions.map((subscription) => (
                    <tr key={subscription.id} className="hover:bg-base-100">
                      <td className="font-medium break-all p-2 sm:p-3 lg:p-4">{subscription.email}</td>
                      <td className="hidden md:table-cell p-2 sm:p-3 lg:p-4">{subscription.organization || '-'}</td>
                  ...
                  <tr>
                    <td colSpan={4} className="text-center py-8 text-base-content/60 text-sm">
