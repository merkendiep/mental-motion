        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="card bg-white shadow-lg rounded-2xl border border-base-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-base-content/60 text-sm">Total Subscribers</p>
                <p className="text-3xl font-bold text-primary mt-1">{totalSubscriptions}</p>
              </div>
          ...
          <div className="card bg-white shadow-lg rounded-2xl border border-base-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-base-content/60 text-sm">Monthly</p>
                <p className="text-3xl font-bold text-success mt-1">{monthlyCount}</p>
              </div>
          ...
          <div className="card bg-white shadow-lg rounded-2xl border border-base-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-base-content/60 text-sm">Quarterly</p>
                <p className="text-3xl font-bold text-info mt-1">{quarterlyCount}</p>
              </div>
          ...
          <div className="card bg-white shadow-lg rounded-2xl border border-base-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-base-content/60 text-sm">Tips</p>
                <p className="text-3xl font-bold text-warning mt-1">{tipsCount}</p>
              </div>
            ...
            <table className="table w-full">
              <thead>
                <tr className="border-b border-base-300">
                  ...
                  <th className="bg-base-100">Organization</th>
                  <th className="bg-base-100">Newsletters</th>
                  <th className="bg-base-100">Subscribed On</th>
                </tr>
              </thead>
              <tbody>
                {subscriptions.length > 0 ? (
                  subscriptions.map((subscription) => (
                    <tr key={subscription.id} className="hover:bg-base-100">
                      <td className="font-medium">{subscription.email}</td>
