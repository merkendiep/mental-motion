      ...
      <div className="hero-content flex-col mx-auto lg:min-h-[650px] lg:gap-16 lg:flex-row-reverse">
        ...
        <div className="text-center lg:text-start">
          ...
          <p className="py-6 lg:max-w-lg">
            Er wordt veel <strong>over</strong> studenten gepraat, vergaderd en
            geschreven. Te vaak mist de <strong>stem van de student</strong>{" "}
            zelf.
          </p>

          <p className={"mb-6"}>
            Daarom zijn we gestart met MentalMotion. Omdat we een beweging en
            een plek willen creëren waar studenten zelf hun oplossing vinden om{" "}
            <strong>mentaal gezond</strong> te worden. We willen de eigen regie
            van en studenten vergroten.
          </p>
      ...
      <div className={"bg-[#58B095] text-white"}>
        <div className="hero-content flex-col mx-auto lg:gap-16 lg:flex-row">
          ...
          <div className="text-center lg:text-start">
            ...
            <p className="py-6 lg:max-w-lg">
              MentalMotion is een <strong>ontmoetingsplek</strong> én een{" "}
              <strong>kenniscentrum</strong> ineen. Want als er iemand expert is
              in weten wat studenten nodig hebben, zijn het studenten zelf. Zij
              begrijpen de problemen waar medestudenten tegenaanlopen als geen
              ander.
            </p>

            <p className={"mb-6"}>
              Daarom werken we vanuit <strong>Peer Support</strong>. Onder
              gelijkgestemden voel je je gezien. Zo zorgen we voor een aanbod
              dat aansluit bij behoeften en voor verbinding met de omgeving en
              elkaar. Zo ontstaat er een sterkere <strong>sociale basis</strong>
              .
            </p>
          </div>
        </div>
